...
function Comments() {
    return (
      <>
        ...
        <section className="py-[40px] bg-[#f9f8f3] flex  flex-col items-center gap-4">
            ...
            <div className="flex flex-col gap-[10px] p-[15px] rounded-md bg-[#fff] border border-[#e8e8e8] ">
              <div className="flex pb-[15px] border-b border-[#e8e8e8] justify-between items-center gap-[10px]">
                <div className="flex flex-col justify-center items-start">
                  ...
                  <p className="text-[13px] opacity-60">28 июня 2021</p>
                </div>
                ...
                <div className="flex flex-col gap-[3px] justify-center items-end">
                  ...
                  <p className="text-[12px] opacity-60">Общая оценка: (4,8) </p>
                </div>
              </div>
          ...
          <button className="text-white px-4 py-2 bg-[#FF7A1B] w-[fit-content]">
            Открыть все отзывы
          </button>
        </section>
      </>
